...
*首个在线上生产环境中持续自主优化排序的 LLM 智能体 —<br>实时观测、自主推理、参数决策、自我纠错，全程无需人工干预。*
...
<td align="center" width="50%">
<h3><a href="docs/dives/zh/">架构解析</a></h3>
</td>
</tr>
</table>
...
<p align="center">
  <img src="figures/arch-overview.png" alt="三层架构" width="70%"/>
</p>
...
<p align="center">
  <img src="figures/arch-data-flow.png" alt="单个 YOLO 周期数据流" width="70%"/>
</p>
...
<p align="center">
  <img src="figures/eval-01.png" alt="GMV 与订单提升轨迹" width="70%"/>
</p>
...
<p align="center">
  <img src="figures/eval-02.png" alt="离线 vs 线上校准轨迹" width="65%"/>
</p>
...
<p align="center">
  <img src="figures/eval-04.png" alt="LLM 修正收敛趋势" width="65%"/>
</p>
...
<table width="100%">
<thead>
<tr><th>#</th><th>文档</th><th>核心问题</th></tr>
</thead>
<tbody>
<tr><td>1</td><td><a href="docs/dives/zh/01-theoretical-foundations.md">理论基础</a></td><td>为什么信念和偏好必须分离？</td></tr>
<tr><td>2</td><td><a href="docs/dives/zh/02-influence-share.md">影响力份额</a></td><td>如何量化每个因子对排序的贡献？</td></tr>
<tr><td>3</td><td><a href="docs/dives/zh/03-dual-channel-mechanism.md">双通道机制</a></td><td>信念通道和偏好通道具体如何运作？</td></tr>
<tr><td>4</td><td><a href="docs/dives/zh/04-llm-meta-controller.md">LLM 元控制器</a></td><td>LLM 做什么，以及它刻意不做什么？</td></tr>
<tr><td>5</td><td><a href="docs/dives/zh/05-search-engine.md">搜索引擎</a></td><td>Optuna 如何在约束下找到最优参数？</td></tr>
<tr><td>6</td><td><a href="docs/dives/zh/06-pipeline-and-operations.md">流水线与运维</a></td><td>单轮如何运行，多轮如何链接为持续运行？</td></tr>
<tr><td>7</td><td><a href="docs/dives/zh/07-memory-architecture.md">记忆架构</a></td><td>为什么持久化记忆是其他一切的前提？</td></tr>
<tr><td>8</td><td><a href="docs/dives/zh/08-meta-reflection.md">元反思</a></td><td>AI 智能体构建 AI 智能体意味着什么？</td></tr>
</tbody>
</table>
...
| 基础框架 | [ParaDance](https://github.com/yinsn/ParaDance) — 源自 2023 年 5 月启动；技术报告称其经历 20 个月核心迭代；PyPI 下载 101K+ |
...
<video src="docs/sortify-demo.mp4" width="80%" controls>
  <a href="docs/sortify-demo.mp4">下载演示视频</a>
</video>
</p>
<p align="center"><sub>与技术报告配套的可视化讲解</sub></p>
